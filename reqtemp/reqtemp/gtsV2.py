...
Generate ONLY a short introductory narrative (2–3 lines) for the "Project Delivery Approach" section for {client_name}'s SAP GTS implementation.
...
def main():
    ...
    if "edited_sections" in st.session_state:
        ...
        if not os.path.exists(template_path):
            st.warning("⚠ V2 template not found, using original template. Please create GTS_Template_V2.docx")
            template_path = "Template/GTS_Template.docx"
